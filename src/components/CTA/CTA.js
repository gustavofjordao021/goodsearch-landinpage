const CTA = (props) => {
  ...
  return (
    <div className="bg-gray-50 w-full flex flex-col text-center items-center py-12 mx-4 px-4 sm:px-8 md:flex-row md:text-left lg:px-12 lg:flex lg:items-center lg:justify-between xl:w-6/12">
