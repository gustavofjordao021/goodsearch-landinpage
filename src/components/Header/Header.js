...
const Header = (props) => {
  ...
  return (
    ...
    {isHeaderVisible ? (
      ...
      <div className="max-w-7xl py-3 px-2 sm:px-8 md:mx-4 lg:px-10">
        <div className="flex items-center justify-between flex-wrap">
          <div className="w-0 flex-1 flex items-center">
            ...
            <p className="ml-3 font-medium text-white truncate">
              <span className="md:hidden">A better way to search is here!</span>
              <span className="hidden md:inline">Big news! We're excited to announce a better way to search.</span>
            </p>
          </div>
