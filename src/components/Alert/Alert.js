    ...
    <>
      {alertType === "error" && isVisible ? (
        ...
        <div className="flex align-middle rounded-md bg-red-100 my-2 w-full h-full">
          ...
          <button>
            <XIcon className="h-6 w-6 bg-red-200 text-white font-extrabold p-1 rounded-md hover:bg-red-800 focus:outline-none focus:ring-2 focus:ring-white sm:-mr-2" aria-hidden="true" onClick={() => toggleAlertVisibility()} />  
          </button>
        </div>
        </>
        ...
        <div className="flex align-middle rounded-md bg-green-100 my-2 w-full h-full">
          ...
          <button>
            <XIcon className="h-6 w-6 bg-green-200 text-white font-extrabold p-1 rounded-md hover:bg-green-800 focus:outline-none focus:ring-2 focus:ring-white sm:-mr-2" aria-hidden="true" onClick={() => toggleAlertVisibility()} />  
          </button>
        </div>
        ...
        <div className="flex align-middle rounded-md bg-blue-100 my-2 w-full h-full">
          ...
          <button>
            <XIcon className="h-6 w-6 bg-blue-200 text-white font-extrabold p-1 rounded-md hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-white sm:-mr-2" aria-hidden="true" onClick={() => toggleAlertVisibility()} />  
          </button>
        </div>
      </>
      ) : ("")}
